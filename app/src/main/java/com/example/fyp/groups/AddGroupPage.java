...
public class AddGroupPage extends AppCompatActivity {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    AddBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            groupName = GroupName.getEditText().getText().toString().trim();
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(AddGroupPage.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Group info = new Group(groupName, String.valueOf(uri), RandomUId, UserId);
                            firebaseDatabase.getInstance().getReference("Group").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                    .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    progressDialog.dismiss();
                                    Toast.makeText(AddGroupPage.this, "Group added successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(AddGroupPage.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
